...
void UturnRight(){
  ...
  while(totalEncoderA<=2460){
    ...
    analogWrite(mAspe,175);
    analogWrite(mBspe,105);
...
void UturnLeft(){
  ...
  while(totalEncoderB<=2080){
    ...
    digitalWrite(BdirB,LOW);
    digitalWrite(BdirF,HIGH);
    analogWrite(mAspe,81);
    analogWrite(mBspe,180);
